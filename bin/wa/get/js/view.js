    ...
    coffee: () => {
      ...
      Via.forEach(i => {
        ...
        DOM[0].push([`div`, {style: {background: (i === `bitcoin`)? `#0c0f0c`: ``, cursor: `pointer`, padding: `${12}px`}}, 
          [[`span`, {style: {[`fnt-size`]: `${10.88}px`, overflow: `hidden`, [`text-overflow`]: `ellipsis`, [`text-transform`]: `capitalize`, [`white-space`]: `nowrap`}}, i]]])
      });

      return [`main`, {id: `donate`, style: {color: `#fff`}},  
        ...
        [`div`, {style: {margin: `${57}px auto`, [`max-width`]: `${720}px`, padding: `${0} ${12}px`, width: `${100}%`}}, 
          ...
          [`div`, {style: {[`margin-top`]: `${24}px`}}, 
            [[`div`, {style: {background: `#161c16`, [`margin-bottom`]: `${24}px`, width: `${100}%`}}, 
              [[`div`, {class: `_gxM _geQ`, style: {width: `${100}%`}}, 
                [[`a`, {id: `setVia`, href: `javascript:;`, style: {background: ``, color: `#fff`, display: `flex`, [`padding`]: `${12}px`, width: `${100}%`}}, 
                  [[`span`, {}, `Bitcoin`], 
                  [`div`, {class: `_gZz`}, 
                    [[`svg`, {viewbox: `0 0 24 24`, style: {height: `${8}px`, width: `${8}px`}}, 
                      [[`path`, {fill: `none`, stroke: `#fff`, [`stroke-width`]: 2, d: `M0 6 12 18 24 6`}]]]]]]], /*DOM[0]*/]]]], 
            [`div`, {class: ``, style: {border: `${1}px solid #2d2d2d`}}, 
              [[`div`, {style: {[`font-size`]: `${9.88}px`, width: `${100}%`, padding: `${12}px`}}, 
                [[`h2`, {style: {[`font-size`]: `${11.88}px`, [`margin-bottom`]: `${24}px`}}, `DONATE WITH BITCOIN`], [`span`, {}, `Amount`], 
                  ...
                  [[`div`, {class: ``}, 
                    [[`div`, {class: `_gZz`, style: {[`align-items`]: `baseline`, [`font-size`]: `${11.88}px`}}, 
                      [[`div`, {style: {[`margin-right`]: `${8}px`, [`text-align`]: `right`}}, 
                        [[`input`, {id: `float`, placeholder: `0.00`, style: {background: `none`, border: `none`, color: `#fff`, [`font-family`]: `aspg`, [`font-size`]: `${16.88}px`, outline: `none`, padding: 0, [`text-align`]: `right`}}], 
                        [`span`, {id: `alias`, style: {[`margin-top`]: `${4}px`}}, `0`]]], 
                      [`div`, {style: {color: `#7d7d7d`}}, [[`span`, {}, `USD`], [`span`, {style: {[`margin-top`]: `${4}px`}}, `BTC`]]]]]]]]], 
                [`div`, {style: {[`margin-top`]: `${12}px`}}, 
                  [[`span`, {}, `Name`], 
                  [`div`, {style: {background: `#161c16`,[`margin-top`]: `${12}px`, padding: `${12}px`}}, 
                    [[`input`, {id: `name`, style: {background: `none`, border: `none`, color: `#fff`, [`font-family`]: `aspg`, [`font-size`]: `${10.88}px`, outline: `none`, padding: 0, [`text-align`]: ``}}]]]]],
                [`div`, {style: {[`margin-top`]: `${12}px`}}, 
                  [[`span`, {}, `Email`], 
                  [`div`, {style: {background: `#161c16`,[`margin-top`]: `${12}px`, padding: `${12}px`}}, 
                    [[`input`, {id: `email`, type: `email`, style: {background: `none`, border: `none`, color: `#fff`, [`font-family`]: `aspg`, [`font-size`]: `${10.88}px`, outline: `none`, padding: 0, [`text-align`]: ``}}]]]]], 
                [`div`, {style: {[`margin-top`]: `${12}px`}}, 
                  [[`span`, {}, `BTC Wallet/Sender Address`], 
                  [`div`, {style: {background: `#161c16`,[`margin-top`]: `${12}px`, padding: `${12}px`}}, 
                    [[`input`, {id: `wallet`, placeholder: `paste address`, style: {background: `none`, border: `none`, color: `#fff`, [`font-family`]: `aspg`, [`font-size`]: `${10.88}px`, outline: `none`, padding: 0, [`text-align`]: ``}}]]]]],
                [`div`, {style: {[`margin-top`]: `${12}px`}}, 
                  ...
                  [`div`, {class: `_gxM geQ`, style: {background: `#161c16`,[`margin-top`]: `${12}px`, padding: `${12}px`}}, 
                    ...
                    [`svg`, {id: `copy`, class: `_gZz`, viewbox: `0 0 24 24`, style: {cursor: `pointer`, display: `flex`, height: `${14}px`, margin: `0 ${8}px`, [`max-width`]: `${14}px`}}, 
                ...
                [`div`, {style: {[`margin-top`]: `${12}px`}}, 
                  [[`div`, {style: {background: `#758a75`,[`margin-top`]: `${12}px`, padding: `${12}px`}}, 
                    [[`a`, {id: `ledge`, for: `BTC`, href: `javascript:;`, style: {color: `#000`, display: `block`, flex: 1, [`font-size`]: `${10.88}px`, overflow: `hidden`, [`text-align`]: `center`, [`text-overflow`]: `ellipsis`}}, `I'VE SENT MY DONATION`]]]]],
                [`div`, {class: `_gxM _geQ`, style: {margin: `${12}px ${0}`}}, 
                  [[`svg`, {id: ``, viewbox: `0 0 24 24`, height: `${18}px`, width: `${18}px`, style: {cursor: `pointer`, margin: `${0} ${0}px`}}, 
